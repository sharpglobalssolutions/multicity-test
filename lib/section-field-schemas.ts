...
export const SECTION_FIELD_SCHEMAS: Record<SectionType, FieldSchema[]> = {
  ...
  BC_QUICK_CONSULT: [
    ...
    text("subheading", "Subheading"),
    {
      ...
      emptyItem: { id: "", city: "", airline: "", price: "", image: "", alt: "" },
    },
  ],
  BC_STATS: [
    {
      ...
      itemFields: [
        ...
        text("suffix", "Suffix"),
        text("label", "Label"),
        text("displayValue", "Display value override (optional — replaces the number, e.g. \"One-Way\")"),
      ],
      emptyItem: { id: "", value: "0", suffix: "", label: "", displayValue: "" },
    },
  ],
  BC_OPTIONS: [text("heading", "Heading"), text("subheading", "Subheading")],
  BC_OPTIONS_ONE_WAY: [
    { key: "eyebrowLines", label: "Heading (one line per entry)", kind: "string-list" },
    textarea("body", "Body"),
    {
      key: "images",
      label: "Images",
  ...
  BC_FARE_COMPLEXITY: [
    ...
    text("subheading", "Subheading"),
    {
      ...
      itemFields: [
        text("id", "ID"),
        text("label", "Label"),
        text("icon", "Icon key (route, armchair, scroll-text, calendar-clock, plane, refresh-cw)"),
      ],
      emptyItem: { id: "", label: "", icon: "plane" },
    },
  ],
  BC_BEYOND_PRICE: [
    text("eyebrow", "Eyebrow (e.g. \"Our Approach\")"),
    { key: "heading", label: "Heading (one line per entry)", kind: "string-list" },
    {
      key: "benefits",
      label: "Benefits",
      kind: "list",
      itemFields: [text("id", "ID"), text("title", "Title"), textarea("description", "Description")],
  ...
  BC_HOW_IT_WORKS: [
    ...
    text("subheading", "Subheading"),
    {
      ...
      itemFields: [
        text("id", "ID"),
        textarea("titleLines", "Title (one line per row)", 2),
        textarea("descriptionLines", "Description (one line per row)", 2),
      ],
      emptyItem: { id: "", titleLines: "", descriptionLines: "" },
    },
  ],
  BC_JOURNEY: [
    {
      ...
      itemFields: [
        ...
        textarea("titleLines", "Title (one line per row)", 3),
        textarea("description", "Description"),
        textarea("factors", "Factors (one per row)", 5),
      ],
      emptyItem: { id: "", image: "", imageAlt: "", titleLines: "", description: "", factors: "" },
    },
  ],
  BC_SERVICES: [
    text("heading", "Heading"),
    {
      ...
      label: "Services",
      kind: "list",
      itemFields: [text("title", "Title"), textarea("description", "Description")],
  ...
  BC_EXPERTISE: [
    { key: "heading", label: "Heading (one line per entry)", kind: "string-list" },
    {
      ...
      kind: "list",
      itemFields: [text("id", "ID"), image("image", "Image"), text("alt", "Image alt text")],
      emptyItem: { id: "", image: "", alt: "" },
    },
    {
      key: "routes",
      ...
      emptyItem: { id: "", originCity: "", destinationCity: "", href: "#" },
    },
  ],
};
