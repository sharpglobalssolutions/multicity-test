...
export function FlightSummaryCard({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-card border border-navy-deep/10 bg-white">
      <div className="p-6 sm:p-8">
        ...
        <div className="mt-7 flex flex-col items-center justify-center gap-2 text-center sm:flex-row sm:gap-3">
          <span className="flex items-center gap-2 text-xl font-bold text-navy-deep sm:text-2xl">
            {fromCity}
        ...
        <div className="mt-8 text-center">
          <h2 className="text-xl font-bold text-navy-deep sm:text-2xl">Congratulations!</h2>
          <p className="mt-2 text-[15px] font-bold text-navy-deep/70">
            Exclusive unpublished fares are available for your flight.
          </p>
        </div>
      </div>

      <div className="mt-auto grid grid-cols-3 divide-x divide-navy-deep/10 border-t border-navy-deep/10 bg-gray-light py-6 text-center">
        {STATS.map((stat) => (
          <div key={stat.label}>
            <p className="text-xl font-bold text-navy-deep sm:text-2xl">{stat.value}</p>
