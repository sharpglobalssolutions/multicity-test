      ...
      <div className="content-container grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <SectionReveal x={-60} className="lg:order-1">
          <h2 className="text-2xl text-text-dark sm:text-4xl lg:text-[30px]">
            Get 24×7 Support When Your Travel Plans Change
          </h2>
          <p className="mt-5 max-w-lg text-[16px] leading-relaxed text-text-gray">
            International travel doesn&apos;t always go according to plan. Flights get rescheduled. Connections are
            missed. Travel dates change. Unexpected situations can turn a straightforward journey into a stressful
            one. That&apos;s why access to human support matters.
          </p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-x-8 gap-y-3 max-w-lg">
            {SUPPORT_ITEMS.map((column, columnIndex) => (
        ...
        <SectionReveal x={60} delay={0.1} className="lg:order-2">
          <div className="relative aspect-[4/3] w-full overflow-hidden sm:aspect-[16/11]">
            <Image
              src={SUPPORT_SPECIALIST_IMAGE.src}
